...
Please see my [ShinyApp](https://www.shinyapps.io/admin/#/application/6719839) to see the distributions plotted as histograms for all transformations.
...
ames %>% 
   ...
   geom_histogram(colour = "black", bins = 30, fill = "#b0afa0") + 
   labs(x = NULL, y = NULL, title = "Distribution of sale price") +
...
ames %>% 
   ...
   geom_histogram(colour = "black", bins = 30, fill = "#b0afa0") + 
   labs(x = NULL, y = NULL, title = "Log transform of sale price") +
   theme(
      axis.text = element_text(face = "bold"),
      plot.title = element_text(face = "bold", size = 16)
   )
...
ames_model %>% 
   ...
   geom_col(colour = "black", fill = "#b0afa0") + 
